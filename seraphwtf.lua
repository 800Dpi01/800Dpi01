...
local fonts = {}
fonts["ProggyClean"] = Font.new("rbxasset://fonts/families/Code.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
fonts["TahomaBold"] = Font.new("rbxasset://fonts/families/Arimo.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
fonts["Pixel"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
fonts["Verdana"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
fonts["Tahoma"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
fonts["Pixel2"] = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
...
local currentText = "v0.2.4-git.fee1197"
...
overshoot_parent:add(fov_tab:slider({name = "overshoot fov", min = 0, max = 360, default = 100, flag = "pf_overshoot_fov"}))
	...
	modules.Tips = {"seraph.wtf on top", "https://seraph.wtf/ get good", "seraph is P100!!!!! ON GOD"}
		...
		do
			...
			library.network:receive("startvotekick", function(playerName, reason)
				if playerName == lp.Name then
					lp:Kick("Random chud votekicked you, finding another server for you king 👑")
	...
	local function onKillSuccess()
		local messages = {"GOYLET GETS DOMED BY THE NEXT COMING OF GOD (SERAPH)", "nice paste..", "real men use seraph", "talk to a brick wall, seraph better", "what's hacking? i'm using a macro called seraph", "need a gaming chair? get seraph.wtf", "get owned by seraph", "get good get seraph", "seraph > you", "need some fun? get seraph.wtf", "powered by seraph", "seraph on top"}
